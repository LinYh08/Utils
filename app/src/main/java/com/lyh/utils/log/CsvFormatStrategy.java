...
import static com.lyh.utils.log.Utils.checkNotNull;
...
public class CsvFormatStrategy implements FormatStrategy {
    ...
    public static final class Builder {
        private static final int MAX_BYTES = 10 * 1024 * 1024; // 10M

        Date date;
        SimpleDateFormat dateFormat;
        LogStrategy logStrategy;
        String tag = "LotteryRobot";
        ...
        public CsvFormatStrategy build() {
            ...
            if (logStrategy == null) {
                ...
                String folder = diskPath + File.separatorChar + "LotteryLogger";
